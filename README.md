...
(Alternatively, add this line "export PATH=/home/jdk-17.0.10/bin/java:${PATH}" to the end of the hidden '.bashrc' file in your home directory, run the command <b>source ~/.bashrc</b>, then the following 3 commands can be be simplified to <b>java -cp MNBC.jar ...</b>)  
