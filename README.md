...
(Alternatively, use the command "<b>mamba create -n java -c conda-forge openjdk</b>" to install Java JDK in mamba (or conda), then run the command "<b>mamba activate java</b>" to activate the Java environment)  
