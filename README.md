...
*********************************************************************************************************  
<b>Prerequisites:</b>  
1. Setup Java: Please download and install Java JDK (version >= 17.0.4) from https://www.oracle.com/ca-en/java/technologies/downloads. In Linux, use the command "<b>wget https://download.oracle.com/java/17/latest/jdk-17_linux-x64_bin.tar.gz</b>" to download the 'jdk-17_linux-x64_bin.tar.gz' file, and decompress it with the command "<b>tar -xzvf jdk-17_linux-x64_bin.tar.gz</b>". Then a new folder 'jdk-17.0.10' appears.  
